...
Examples:
  ...
  gt install ~/gt --shell                      # Install shell integration (sets GT_ROOT/GT_RIG)
...
func init() {
	...
	installCmd.Flags().BoolVar(&installShell, "shell", false, "Install shell integration (sets GT_ROOT/GT_RIG env vars)")
